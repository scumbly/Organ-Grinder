...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class Physics2dIgnoreCollision : FsmStateAction
	{
		...
		public void doIgnoreCollision()
		{
			...
			if (go1==null || go1.GetComponent<Collider2D>()==null)
			{
				return;
			}
			
			GameObject go2 = collider2.Value;
			if (go2==null || go2.GetComponent<Collider2D>()==null)
			{
				return;
			}
			...
			#if UNITY_4_3 || UNITY_4_4
			#else
			Physics2D.IgnoreCollision(go1.GetComponent<Collider2D>(), go2.GetComponent<Collider2D>(),ignoreCollision.Value);
			#endif
		}
